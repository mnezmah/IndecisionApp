  ...
  _createClass(IndecisionApp, [{
    ...
    value: function handleAddOption(option) {
      if (!option) {
        ...
        // indexOf prikazuke koja je po redu upravo upisana vrijendost u options arrayu. Ako je već u  arrayu, znači da ima vrijednost veću od -1. -1 znači da ne postoji
